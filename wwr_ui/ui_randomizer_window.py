...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.update_checker_label, 3, 0, 1, 1)
        ...
        self.verticalLayout_7.addWidget(self.label_for_randomized_gear)
        ...
        self.verticalLayout_7.addWidget(self.randomized_gear)
        ...
        self.verticalLayout_8.addWidget(self.remove_gear)
        ...
        self.verticalLayout_8.addWidget(self.add_gear)
        ...
        self.glitches_bomb_boost = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_bomb_boost.setObjectName("glitches_bomb_boost")
        self.gridLayout_8.addWidget(self.glitches_bomb_boost, 1, 2, 1, 1)
        self.glitches_Lslide = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_Lslide.setObjectName("glitches_Lslide")
        self.gridLayout_8.addWidget(self.glitches_Lslide, 1, 1, 1, 1)
        self.glitches_ww_wind_cancel = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_ww_wind_cancel.setObjectName("glitches_ww_wind_cancel")
        self.gridLayout_8.addWidget(self.glitches_ww_wind_cancel, 2, 1, 1, 1)
        self.glitches_wwdives = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_wwdives.setObjectName("glitches_wwdives")
        self.gridLayout_8.addWidget(self.glitches_wwdives, 2, 0, 1, 1)
        self.glitches_leaf_pumps = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_leaf_pumps.setObjectName("glitches_leaf_pumps")
        self.gridLayout_8.addWidget(self.glitches_leaf_pumps, 0, 3, 1, 1)
        self.glitches_sidle_clips = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_sidle_clips.setObjectName("glitches_sidle_clips")
        self.gridLayout_8.addWidget(self.glitches_sidle_clips, 2, 2, 1, 1)
        self.glitches_weapons_thru_rooms = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_weapons_thru_rooms.setCheckable(True)
        self.glitches_weapons_thru_rooms.setObjectName("glitches_weapons_thru_rooms")
        self.gridLayout_8.addWidget(self.glitches_weapons_thru_rooms, 1, 3, 1, 1)
        self.glitches_spring_jump_storage = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_spring_jump_storage.setObjectName("glitches_spring_jump_storage")
        self.gridLayout_8.addWidget(self.glitches_spring_jump_storage, 1, 0, 1, 1)
        self.glitches_door_cancel = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_door_cancel.setObjectName("glitches_door_cancel")
        self.gridLayout_8.addWidget(self.glitches_door_cancel, 2, 3, 1, 1)
        self.glitches_ledge_clips = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_ledge_clips.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
        self.glitches_ledge_clips.setToolTipDuration(-8)
        self.glitches_ledge_clips.setAutoFillBackground(False)
        self.glitches_ledge_clips.setObjectName("glitches_ledge_clips")
        self.gridLayout_8.addWidget(self.glitches_ledge_clips, 0, 0, 1, 1)
        self.glitches_door_storage = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_door_storage.setObjectName("glitches_door_storage")
        self.gridLayout_8.addWidget(self.glitches_door_storage, 0, 2, 1, 1)
        self.glitches_roll_clips = QtWidgets.QCheckBox(self.layoutWidget)
        self.glitches_roll_clips.setObjectName("glitches_roll_clips")
        self.gridLayout_8.addWidget(self.glitches_roll_clips, 0, 1, 1, 1)
        self.glitches_korl_cyclones = QtWidgets.QCheckBox(self.layoutWidget)
        ...
        self.glitchComboBox = QtWidgets.QComboBox(self.groupBox_4)
        self.glitchComboBox.setGeometry(QtCore.QRect(140, 20, 461, 21))
        self.glitchComboBox.setFocusPolicy(QtCore.Qt.WheelFocus)
        ...
        self.glitchComboBox.setItemText(0, "")
        self.glitchList = QtWidgets.QListView(self.groupBox_4)
        self.glitchList.setGeometry(QtCore.QRect(140, 50, 461, 201))
        self.glitchList.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.glitchList.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.glitchList.setObjectName("glitchList")
        self.glitchRemoveTrick = QtWidgets.QPushButton(self.groupBox_4)
        self.glitchRemoveTrick.setGeometry(QtCore.QRect(280, 260, 75, 23))
        self.glitchRemoveTrick.setObjectName("glitchRemoveTrick")
        self.glitchClearList = QtWidgets.QPushButton(self.groupBox_4)
        self.glitchClearList.setGeometry(QtCore.QRect(380, 260, 75, 23))
        self.glitchClearList.setObjectName("glitchClearList")
        ...
        self.gridLayout_6.addWidget(self.option_description, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox1.setTitle(QtWidgets.QApplication.translate("MainWindow", "Multi-Use Glitches", None, -1))
        self.glitches_bomb_boost.setText(QtWidgets.QApplication.translate("MainWindow", "Bomb Boosts", None, -1))
        self.glitches_Lslide.setText(QtWidgets.QApplication.translate("MainWindow", "L-Slide Clips", None, -1))
        self.glitches_ww_wind_cancel.setText(QtWidgets.QApplication.translate("MainWindow", "Wind Waker Wind Cancels", None, -1))
        self.glitches_wwdives.setText(QtWidgets.QApplication.translate("MainWindow", "Wind Waker Dives", None, -1))
        self.glitches_leaf_pumps.setText(QtWidgets.QApplication.translate("MainWindow", "Leaf Pumps", None, -1))
        self.glitches_sidle_clips.setText(QtWidgets.QApplication.translate("MainWindow", "Sidle Clips", None, -1))
        self.glitches_weapons_thru_rooms.setText(QtWidgets.QApplication.translate("MainWindow", "Enemy Weapon Transfer", None, -1))
        self.glitches_spring_jump_storage.setText(QtWidgets.QApplication.translate("MainWindow", "Spring Jump Storage", None, -1))
        self.glitches_door_cancel.setText(QtWidgets.QApplication.translate("MainWindow", "Door Cancel", None, -1))
        self.glitches_ledge_clips.setText(QtWidgets.QApplication.translate("MainWindow", "Ledge Clips", None, -1))
        self.glitches_door_storage.setText(QtWidgets.QApplication.translate("MainWindow", "Door Storage", None, -1))
