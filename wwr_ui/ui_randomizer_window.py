...
#
# Created: Thu Oct 17 15:29:57 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_for_active_locations = QtWidgets.QLabel(self.tab_4)
        self.label_for_active_locations.setObjectName("label_for_active_locations")
        self.verticalLayout_11.addWidget(self.label_for_active_locations)
        self.active_locations = QtWidgets.QListView(self.tab_4)
        self.active_locations.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.active_locations.setObjectName("active_locations")
        self.verticalLayout_11.addWidget(self.active_locations)
        ...
        self.add_location = QtWidgets.QPushButton(self.tab_4)
        self.add_location.setMinimumSize(QtCore.QSize(0, 80))
        self.add_location.setObjectName("add_location")
        self.verticalLayout_13.addWidget(self.add_location)
        self.remove_location = QtWidgets.QPushButton(self.tab_4)
        self.remove_location.setMinimumSize(QtCore.QSize(0, 80))
        self.remove_location.setObjectName("remove_location")
        self.verticalLayout_13.addWidget(self.remove_location)
        ...
        self.label_for_inactive_locations = QtWidgets.QLabel(self.tab_4)
        self.label_for_inactive_locations.setObjectName("label_for_inactive_locations")
        self.verticalLayout_12.addWidget(self.label_for_inactive_locations)
        self.inactive_locations = QtWidgets.QListView(self.tab_4)
        self.inactive_locations.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.inactive_locations.setObjectName("inactive_locations")
        self.verticalLayout_12.addWidget(self.inactive_locations)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_for_active_locations.setText(QtWidgets.QApplication.translate("MainWindow", "Active Locations", None, -1))
        self.add_location.setText(QtWidgets.QApplication.translate("MainWindow", "<-", None, -1))
        self.remove_location.setText(QtWidgets.QApplication.translate("MainWindow", "->", None, -1))
        self.label_for_inactive_locations.setText(QtWidgets.QApplication.translate("MainWindow", "Inactive Locations", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtWidgets.QApplication.translate("MainWindow", "Detailed Locations", None, -1))
